...
public class InputHandler : MonoBehaviour
{
    ...
    public static bool Player1Jump { get; private set; }      // Left Shift (left side)
    public static bool Player2Jump { get; private set; }      // Right Shift (right side)
    ...
    private void Update()
    {
        ...
        // Held state so the controller can tell a solo jump from a coordinated one
        Player1Jump = keyboard.leftShiftKey.isPressed;
        Player2Jump = keyboard.rightShiftKey.isPressed;
    }
}